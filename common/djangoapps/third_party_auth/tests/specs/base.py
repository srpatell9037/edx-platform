...
class HelperMixin(object):
    ...
    def _get_login_post_request(self, strategy):
        ...
        # Note: It doesn't seem exactly right to copy all this from strategy.request, but
        # this is more correct than the earlier version of this code that used strategy.request
        # for login, rather than a POST request to login_api.
